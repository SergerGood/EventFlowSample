...
public class ExampleTests
{
    ...
    public async Task ShouldHandleQuery()
    {
        ...
        using var resolver = EventFlowOptions.New
            ...
            .UseInMemoryReadStoreFor<AggregateReadModel>()
            .AddQueryHandler<
                GetMagicNumberByAggregateQueryHandler<IInMemoryReadStore<AggregateReadModel>, AggregateReadModel>,
                GetMagicNumberByAggregateQuery, int>()
            .CreateResolver();
        ...
        var readMagicNumber = await queryProcessor.ProcessAsync(query, tokenSource.Token);
